...
- [x] T027 [P] Setup Actuator endpoints (/actuator/health, /actuator/metrics) for monitoring
...
- [x] T032 Create test profile configuration (application-test.yml)
...
- [X] T035 [P] Create ProductAttribute.java entity with: id, product_id, name, type (TEXT/SELECT/NUMBER/DATE_RANGE), values (JSON)
...
- [X] T046 [P] Create InventoryService.java implementing:
